...
6. 列声明只是起点，最终需要通过 [EXPLAIN 使用方法](../08-Performance-Diagnostics/EXPLAIN-使用方法.md) 和真实数据分布验证。
...
详见：[ALTER TABLE 修改表](../02-Schema-DDL/ALTER-TABLE-修改表.md) 与 [Online DDL](../02-Schema-DDL/Online-DDL.md)。

## 12. 相关主题

- [DataType 数据类型](DataType-数据类型.md)
- [整数类型](../0-BASES/MySQL-Data-Types/整数类型.md)
- [定点与位类型](../0-BASES/MySQL-Data-Types/定点与位类型.md)
- [字符串与二进制类型](../0-BASES/MySQL-Data-Types/字符串.md)
- [日期类型](../0-BASES/MySQL-Data-Types/日期.md)
- [JSON 类型](../0-BASES/MySQL-Data-Types/JSON-类型.md)
- [空间数据类型](../0-BASES/MySQL-Data-Types/空间数据类型.md)
