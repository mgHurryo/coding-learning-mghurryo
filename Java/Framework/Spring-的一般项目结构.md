...
| 层次 | 放什么 | 示例 |
|------|--------|------|
| 领域基础知识 | 协议、数据库、安全概念 | [RESTful-API-Design](../../Network/HTTP/Concept/RESTful-API-Design.md)[JDBC URL](../../MySQL/12-Java-Persistence/JDBC-URL.md)、[JWT-无状态认证](../../Security/Authentication/JWT-无状态认证.md) |
| 框架实现知识 | Spring Boot、MyBatis、Validation 等实现 | [10-RESTful-API与参数校验](Spring-Boot/Learning/Start/10-RESTful-API与参数校验.md) |
| 集成模式知识 | 多个技术组合后的工程模式 | [12-Spring-Security-JWT无状态认证](Spring-Boot/Learning/Start/12-Spring-Security-JWT无状态认证.md) |
| 项目案例知识 | 某个项目如何应用这些知识 | [12-项目完整分析总结](Spring-Boot/Projects/Big-event/12-项目完整分析总结.md) |

## 相关主题

- [13-Lombok与DTO模式](Spring-Boot/Learning/Start/13-Lombok与DTO模式.md)
- [11-全局异常处理与统一响应](Spring-Boot/Learning/Start/11-全局异常处理与统一响应.md)
