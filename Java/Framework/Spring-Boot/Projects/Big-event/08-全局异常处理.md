---
title: 全局异常处理
description: @RestControllerAdvice 原理、特定异常 vs 全局异常处理、统一错误响应设计
created: 2026-06-28
...
> 关联笔记：[05-JWT-令牌机制](05-JWT-令牌机制.md) | [02-RESTful-API设计](02-RESTful-API设计.md)
...
> 🔗 **下一步学习：** [09-密码加密与安全](09-密码加密与安全.md) → 密码存储安全机制
